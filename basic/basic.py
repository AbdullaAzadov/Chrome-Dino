...
dino = pygame.image.load(path + "dino.png")
...
while play:
    ...
    # Перемещение фона  
        ...
        if ground_x - enemy_speed < -2 * SCREEN_WIDTH: 
            ground_x = SCREEN_HEIGHT * 2
        if tmp_ground_x - enemy_speed < -2 * SCREEN_WIDTH: 
            tmp_ground_x = SCREEN_HEIGHT * 2
